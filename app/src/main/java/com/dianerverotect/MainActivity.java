...
public class MainActivity extends AppCompatActivity implements NavigationBarView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.add(R.id.fragment_container, alsFragment, "als");
        transaction.add(R.id.fragment_container, chatbotFragment, "nervebot");
        transaction.add(R.id.fragment_container, historyFragment, "history");
